...
//
//void
//Median::medianFilter(ImagePtr I1, int thr, ImagePtr I2) {
...
//
//void
//Median::copyToBuffer(ChannelPtr<uchar> &p1, int width, short* buffer, int bufSz) {
//    buffer[0] = *p1; //0?
